      ...
      <div className="max-w-3xl w-full bg-slate-900 border border-slate-800 rounded-xl p-8 shadow-2xl flex flex-col items-center gap-6">
        ...
        <div className="text-center w-full flex flex-col items-center">
          ...
          <p className="text-sm text-slate-400 mt-1 w-full text-left">
            {errorMsg && <span className="text-red-400 block mb-1">{errorMsg}</span>}
        ...
        {isLoading && (
          <div className="flex items-center gap-3 text-sm text-slate-400">
            <Loader2 className="w-5 h-5 animate-spin text-purple-400" /> Reading pages...
          </div>
        )}
        ...
        {step === 'select' && !isLoading && (
          <div className="w-full flex flex-col gap-4">
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm font-medium text-slate-300">{thumbnails.length} page(s)</span>
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => rotateAll(90)}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-slate-700 text-slate-300 hover:border-purple-500 hover:text-white transition-colors"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 max-h-[55vh] overflow-y-auto pr-1">
              {thumbnails.map((thumb, idx) => (
                <div key={thumb.page} className="flex flex-col items-center gap-2 rounded-xl border border-slate-800 bg-slate-950/60 p-3">
                  ...
                  <div className="flex items-center justify-between w-full gap-1">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="p-1.5 rounded-md border border-slate-700 text-slate-400 hover:border-purple-500 hover:text-purple-300 transition-colors"
                      >
